...
-- Seed: feriados nacionais 2026-2028 (APENAS OBRIGATÓRIOS).
-- Lei 662/1949 + Lei 14.759/2023 — feriados nacionais oficiais.
-- NÃO inclui Carnaval (seg+ter) nem Corpus Christi — são pontos
-- facultativos, não feriado nacional. Empresa pode escolher folgar,
-- mas não conta como dia útil obrigatório.
--
-- MUNICIPAL: 15 de agosto — Nossa Senhora dos Prazeres, padroeira de
-- Lages-SC (Lei Municipal 70/1967). Único feriado municipal oficial
-- da cidade (aniversário da cidade NÃO é feriado).
...
('2026-08-15', 'Nossa Senhora dos Prazeres (Lages-SC)','custom'),
...
('2027-08-15', 'Nossa Senhora dos Prazeres (Lages-SC)','custom'),
...
('2028-08-15', 'Nossa Senhora dos Prazeres (Lages-SC)','custom'),
